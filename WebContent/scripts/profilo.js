document.addEventListener("DOMContentLoaded", function () {
    var form = document.querySelector("form[action$='/common/profilo']");
    if (!form) return;
	...
	var regole = {
	        ...
	        viaNumciv: {  regex: /^[A-Za-zÀ-ÿ\s']+\s+\d+$/, msg: "Inserisci la via seguita dal numero civico (es. Via Roma 12)." },
	        ...
	        codicePostale:       { regex: /^[A-Za-z0-9\s-]{2,12}$/, msg: "Inserisci un codice postale valido." },
