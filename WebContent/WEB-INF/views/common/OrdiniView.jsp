    ...
    <div class="profilo-layout">
        ...
        <nav class="profilo-nav">
            <a href="${pageContext.request.contextPath}/common/profilo?view=ordini"
               class="profilo-nav-link active">Ordini e fatture</a>
                        ...
                        <div class="ordine-card">
                            ...
                            <div class="ordine-body">
                                <div class="ordine-field">
                                    <span class="ordine-field-label">Totale</span>
                            ...
                            <div class="ordine-footer" style="display:flex; gap:10px;">

							    <%-- Bottone rimborso --%>
							    <c:if test="${ordine.stato != 'RIMBORSATO'}">
							        <form action="${pageContext.request.contextPath}/common/profilo"
							              method="post">
							            <input type="hidden" name="action"   value="rimborsa"/>
