...
public class MoboDAOImpl implements MoboDAO {
	...
	public synchronized void doSave(MoboBean mobo) throws SQLException {
		...
		String sql = "INSERT INTO " + TABLE_NAME
				+ " (chipset, socket, tiporam, maxfreq, formato, pcie, slotram, nvme, portesata, porteusb, fk_prodotto) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
	...
	public synchronized boolean doUpdate(MoboBean mobo) throws SQLException {
		...
		String sql = "UPDATE " + TABLE_NAME
				+ " SET chipset = ?, socket = ?, tiporam = ?, maxfreq = ?, formato = ?, pcie = ?, slotram = ?, nvme = ?, portesata = ?, porteusb = ? WHERE id_mobo = ?";
