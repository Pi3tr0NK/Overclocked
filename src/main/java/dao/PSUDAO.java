...
public interface PSUDAO {
	...
	public Collection<PSUBean> doRetrieveAll(String categoria, double prezzo,String marca, int potenza, String certificazione, String modulare) throws SQLException;
