...
public interface PSUDAO {
	...
	public Collection<PSUBean> doRetrieveAll(String categoria, String prezzo,String marca, String potenza, String certificazione, String modulare) throws SQLException;
