...
public class ImmaginiDAOImpl implements ImmaginiDAO {
	...
	public synchronized void updateImage(int idImmagine, String path, int idProdotto) throws SQLException {
		String sql = "UPDATE " + TABLE_NAME + " SET path= ? WHERE id_immagine = ? AND fk_prodotto= ?";
