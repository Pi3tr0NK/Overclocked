...
public void doSave(MemoriaBean cpu) throws SQLException;
	...
	public Collection<MemoriaBean> doRetrieveAll(String categoria, String prezzo, String marca, String capacita, String tipo, String tecnologia) throws SQLException;
